...
| `dw` / `db` / `d0` / `d# Zotero Neo User Guide
...
- Marks set with persistence disabled live for the current reader session only.
 ...
 | Delete through word/back-word/line-start/line-end motion                                      |
| `yh/yj/yk/yl`         | Yank through the corresponding character/line motion                                                    |
| `yw` / `yb` / `y0` / `y# Zotero Neo User Guide
...
- Marks set with persistence disabled live for the current reader session only.
 ...
 | Yank through word/back-word/line-start/line-end motion                                          |
| `ch/cj/ck/cl`         | Change through the corresponding character/line motion and enter Insert                                 |
| `cw` / `cb` / `c0` / `c# Zotero Neo User Guide
...
- Marks set with persistence disabled live for the current reader session only.
 ...
 | Change through word/back-word/line-start/line-end motion                                        |
